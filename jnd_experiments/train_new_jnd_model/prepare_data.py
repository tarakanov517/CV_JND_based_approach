...
BASE_DIR = Path('/home/misavinov/scratch/ws/my_space/cifar10')
JND_DIR = BASE_DIR / 'cifar10_jnd'
...
def process_single_image(task):
    ...
    try:
        ...
        jnd_model.find_La_with_background(L_patch = L_physical)
...
if __name__ == '__main__':
    freeze_support()
    save_jnd_folder(BASE_DIR / 'train', JND_DIR / 'train_jnd')
    save_jnd_folder(BASE_DIR / 'test', JND_DIR / 'test_jnd')
    print('Done!')